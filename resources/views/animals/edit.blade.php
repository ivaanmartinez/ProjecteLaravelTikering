        ...
        <div class="col-md-8 offset-md-2">
            ...
            <form action="{{ route('animals.update', $animal->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pais" class="form-control" value="{{ $animal->pais }}" required>
                </div>
                <div class="form-group">
                    <label for="poblacio">poblacio</label>
                    <input type="number" name="poblacio" class="form-control" value="{{ $animal->poblacio }}" required>
                </div>
                <div class="form-group">
                    <label for="amenaca">amenaca</label>
                    <input type="text" name="amenaca" class="form-control" value="{{ $animal->amenaca }}" required>
                </div>
                <div class="form-group">
                    <label for="estat">estat</label>
                    <input type="text" name="estat" class="form-control" value="{{ $animal->estat }}" required>
                </div>
